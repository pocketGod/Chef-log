...
import { EventsListPage } from './features/events/pages/events-list/events-list.page';
import { authGuard } from './core/auth/auth.guard';
import { LoginPage } from './features/common/pages/login.page';
import { EventEditorPage } from './features/events/pages/event-editor/event-editor.page';
